...
perl scripts/Training.pl $scriptpath/scripts/Config.pm 2>&1 | tee log_synthesis_$NMFILE.txt
		...
		\item hasil synthesis dapat di cek di folder \textbf{gen/qst001/ver1/}
		
	\end{enumerate}

	\subsection{Tracking Proses Synthesis}.
	...
	\begin{enumerate}
		\item Buka jendela terminal/shell di alamat file log\_synthesis\_10062019\_1444.txt berada.
...
cat log_synthesis_10062019_1444.txt | grep "Start"
		...
		Semisal hasilnya:
		\begin{minted}[frame=lines,framesep=2mm,fontsize=\footnotesize,bgcolor=LightGray]{bash}
Start preparing environments at Sen Jun 10 19:18:26 WIB 2019
Start computing variance floors at Sen Jun 10 19:18:26 WIB 2019
Start initialization & reestimation at Sen Jun 10 19:18:28 WIB 2019
Start making a monophone mmf at Sen Jun 10 19:23:10 WIB 2019
Start embedded reestimation (monophone) at Sen Jun 10 19:23:10 WIB 2019
Start copying monophone mmf to fullcontext one at Sen Jun 10 19:36:47 WIB 2019
Start embedded reestimation (fullcontext) at Sen Jun 10 19:36:58 WIB 2019
Start tree-based context clustering at Sen Jun 10 19:39:55 WIB 2019
		\end{minted}
...
tail -n35 scripts/Config.pm
	...
	Variabel DATASET dan SPEAKER digunakan jika ingin memilih DATASET atau SPEAKER yang berbeda namun dalam satu paket dataset.
...
DATASET=XXXX SPEAKER=YYYY
	...
	\begin{enumerate}
		...
		Maka perintah konfigurasi dapat seperti berikut:
...
--with-hts-engine-search-path=$TOOLS_DIR/bin
		...
		\textbf{Perhatikan}: Setelah baris terakhir tidak ada tanda '\textbackslash'
		
		Atau boleh juga (opsional) dengan menentukan DATASET dan SPEAKER nya:
