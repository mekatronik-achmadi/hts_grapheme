...
make all 2>&1 | tee log_prepare_$NMFILE.txt
		...
		Selain tampil di terminal, progres akan tercatat di file log\_prepare\_jamtanggal.txt
...
perl scripts/Training.pl $scriptpath/scripts/Config.pm 2>&1 | tee log_synthesis_$NMFILE.txt
		...
		Selain tampil di terminal, progres akan tercatat di file log\_synthesis\_jamtanggal.txt
